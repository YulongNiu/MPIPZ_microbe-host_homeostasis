...
working_dir="/netscratch/dep_psl/grp_psl/Ka-Wai/pwer_002/"

# data_dir is the folder where the raw data (and maping file) are deposited
data_dir="/biodata/dep_psl/grp_psl/Ka-Wai/Miseq_070819_miseq002/"
ref_seqs=$data_dir"/pwer_002_ref_seqs.fasta"
mapping_file=$data_dir"/pwer_002_mapping.txt"
