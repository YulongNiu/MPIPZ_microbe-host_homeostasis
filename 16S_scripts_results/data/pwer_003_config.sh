...
#
# originally by Ruben Garrido-Oter, modified by Ka-Wai
...
working_dir="/netscratch/dep_psl/grp_psl/Ka-Wai/pwer_003new/"

# data_dir is the folder where the raw data (and maping file) are deposited
data_dir="/biodata/dep_psl/grp_psl/Ka-Wai/Miseq_122319_miseq003/"
ref_seqs=$data_dir"/pwer_003_ref_seqs.fasta"
mapping_file=$data_dir"/pwer_003_mapping.txt"

# paths to relevant reference database files
refdata_dir="/biodata/dep_psl/grp_psl/tools/16s/ref_data"
...
usearch_dir="/biodata/dep_psl/grp_psl/tools/usearch/"
